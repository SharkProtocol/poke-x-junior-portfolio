...
└─ documentation, screenshots, architecture notes

private operational repository
└─ real source code, API logic, database access, admin behavior, payment planning

production environment
└─ real environment variables, production database, payment credentials, webhook secrets
```
